...
async def analyze_racing_data(
    ...
    try:
        ...
        # Increased to 6 to minimize API calls due to Free Tier Daily Quota (20 requests/day).
        # Since the frontend now compresses images to 50%, large batches should not crash.
        batch_size = 6
